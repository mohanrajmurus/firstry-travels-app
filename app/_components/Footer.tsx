      ...
      <div className="container mx-auto py-5 lg:py-10 px-4">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-6">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-btnText text-sm">
              Made in Kanchipuram with Love
            </p>
          </div>

          <div className="flex flex-col items-center lg:items-end gap-4">
            <p className="text-gray-300">Contact : +1 (123) 456-7890</p>
        ...
        <div className="flex justify-center mt-6 lg:mt-0">
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Firstry Travels. All rights
            reserved.
          </p>
        </div>
      </div>
